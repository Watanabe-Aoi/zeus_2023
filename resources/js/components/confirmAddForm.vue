    ...
    <div class="container">
        <HeadContent />
            <table>
                ...
                <tr><th>タイトル:</th><td>{{ this.$route.params.new_book.title }}</td></tr>
                <tr><th>著者:</th><td>{{ $route.params.new_book.author }}</td></tr>
                <tr><th>訳者:</th><td>{{  }}</td></tr>
                <tr><th>出版社:</th><td>{{  }}</td></tr>
                <tr><th>出版日:</th><td>{{  }}</td></tr>
