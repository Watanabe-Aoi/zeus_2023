<template>
    <div class="content">
        ...
        <table>
            <tr>
                <th>著者：</th>
                <td>{{ lending_book.author }}</td>
            </tr>
            <tr>
                <th>訳者：</th>
                <td>{{ lending_book.translator }}</td>
            </tr>
            <tr>
                <th>出版社：</th>
