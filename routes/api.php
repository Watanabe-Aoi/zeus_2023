...
Route::post('/book_catalog', [BookController::class, 'index']);
Route::post('/book_catalog/delete', [BookController::class, 'deleteBook']);
Route::post('/return', [BookController::class, 'returnOrBorrowBook']);
